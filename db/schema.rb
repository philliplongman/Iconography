...
ActiveRecord::Schema.define(version: 2019_11_16_033330) do
  ...
  create_table "concerns", force: :cascade do |t|
    ...
    t.text "notes"
    t.index ["domain_id"], name: "index_concerns_on_domain_id"
    t.index ["icon_id", "domain_id"], name: "index_concerns_on_icon_id_and_domain_id", unique: true
    t.index ["icon_id"], name: "index_concerns_on_icon_id"
  end
  ...
  add_foreign_key "concerns", "domains", on_delete: :cascade
